// src/app/api/baseline/elementor-elements/route.ts
// GET ?siteId=&pageId= — list Elementor elements on a page (flat with paths + ids).
...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    builtWithElementor: !!r.data?.built_with_elementor,
    elementorVersion: r.data?.elementor_version || null,
    count: r.data?.count || 0,
    elements: (r.data?.elements as any[]) || [],
